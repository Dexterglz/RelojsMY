...
public class HeartFragment extends ParamFragment {
    ...
    protected void observeViewModel() {
        ...
        viewModel.heartValue().observe(getViewLifecycleOwner(), v -> {
        ...
        minFromChart(vm.getHeartChart()).observe(getViewLifecycleOwner(), v -> {
            binding.lowest.setText(v+"");
        });
        maxFromChart(vm.getHeartChart()).observe(getViewLifecycleOwner(), v -> {
            binding.highest.setText(v+"");
        });
        avgFromChart(vm.getHeartChart()).observe(getViewLifecycleOwner(), v -> {
