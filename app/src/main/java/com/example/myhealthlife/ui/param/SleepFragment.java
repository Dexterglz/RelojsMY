...
public class SleepFragment extends ParamFragment {
    ...
    protected void observeViewModel() {
        ...
        viewModel.sleepValue().observe(getViewLifecycleOwner(), v -> {
        ...
        minFromChart(vm.getSleepChart()).observe(getViewLifecycleOwner(), v -> {
            binding.lowest.setText(v+"");
        });
        maxFromChart(vm.getSleepChart()).observe(getViewLifecycleOwner(), v -> {
            binding.highest.setText(v+"");
        });
        avgFromChart(vm.getSleepChart()).observe(getViewLifecycleOwner(), v -> {
