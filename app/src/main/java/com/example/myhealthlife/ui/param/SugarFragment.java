...
public class SugarFragment extends ParamFragment {
    ...
    protected void observeViewModel() {
        ...
        //Establecer dato actual
            viewModel.sugarValue().observe(getViewLifecycleOwner(), v -> {
        ...
        minFromChart(vm.getSugarChart()).observe(getViewLifecycleOwner(), v -> {
            binding.lowest.setText(v+"");
        });
        maxFromChart(vm.getSugarChart()).observe(getViewLifecycleOwner(), v -> {
            binding.highest.setText(v+"");
        });
        avgFromChart(vm.getSugarChart()).observe(getViewLifecycleOwner(), v -> {
