package com.example.myhealthlife.ecg.view;
...
public class Cardiograph2View extends View {
    ...
    public void initBackground(Canvas canvas) {
        ...
        if (!isHome) {
            canvas.drawText(context.getString(R.string.ecg), 2 * mSGridWidth, (hNum - 2) * mGridWidth, mPaint);
        } else {
            canvas.drawText(context.getString(R.string.ecg), 2 * mSGridWidth, (hNum - 1) * mGridWidth, mPaint);
        }
