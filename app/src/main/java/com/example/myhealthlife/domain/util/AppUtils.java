...
import com.example.myhealthlife.domain.chart.DataPoint;
import com.example.myhealthlife.domain.HistoryData;
import com.example.myhealthlife.domain.PrefsHelper;
import com.example.myhealthlife.domain.TabManager;
...
public class AppUtils {
            ...
            case "hoy": {
                ...
                for (HistoryData r : lista) {
                    ...
                    if (mismoDia) {
                        ...
                        Float valor = obtenerValorParametro(r, tipoDato);
    ...
    private static float obtenerValorParametro(HistoryData r, TipoDato tipoDato) {
        switch (tipoDato) {
            case HEART_VALUE: return r.heartValue;
            case HRV_VALUE: return r.hrvValue;
            case CVRR_VALUE: return r.cvrrValue;
            case OXYGEN_VALUE: return r.oxygenValue;
            case STEP_VALUE: return r.stepValue;
            case DIASTOLIC_VALUE: return r.diastolicValue;
            case SYSTOLIC_VALUE: return r.systolicValue;
            case RESP_RATE_VALUE: return r.respRateValue;
            case BODY_FAT_VALUE: return r.bodyFatValue;
            case BODY_FAT_FRAC_VALUE: return r.bodyFatFracValue;
            case BLOOD_SUGAR_VALUE: return r.bloodSugarValue;
            case TEMP:
    ...
    public static void graficarDatosMedicos(Activity activity, int graphColor, int graphID, String intervalo, TipoDato param, String unidad) {
        ...
        ArrayList<DataPoint> dataPoints = prepararDatosGrafico(listaRecuperada, param, intervalo);
        ...
        // Crear el dataset
        LineDataSet dataSet = new LineDataSet(entries, paramStr(param));
        ...
        CustomMarkerView marker = new CustomMarkerView(activity, R.layout.custom_marker, array,intervalo,paramStr(param));
    ...
    private static float getAverage(Activity activity, TipoDato param, String intervalo) {
        ...
        // Obtener los datapoints
        ArrayList<HistoryData> listaRecuperada = PrefsHelper.obtenerHistorial(activity);
        ArrayList<DataPoint> lista = prepararDatosGrafico(listaRecuperada, param, intervalo);
    ...
    private static String getActual(Activity activity, TipoDato param) {
        ...
        float dato = obtenerValorParametro(lista,param);
        if(dato > 1){
