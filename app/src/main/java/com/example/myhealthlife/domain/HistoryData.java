...
public class HistoryData {
    ...
    public int sleepIntValue;
    public int sleepFloatValue;

    public int trygIntValue;
    public int trygFloatValue;
    ...
    public HistoryData(int heartValue, int hrvValue, int cvrrValue, int oxygenValue, int stepValue,
                         ...
                         int sleepIntValue, int sleepFloatValue, int trygIntValue, int trygFloatValue,
                         int uricAcidValue, long timestamp) {
        ...
        this.sleepIntValue = sleepIntValue;
        this.sleepFloatValue = sleepFloatValue;
        this.trygIntValue = trygIntValue;
        this.trygFloatValue = trygFloatValue;
